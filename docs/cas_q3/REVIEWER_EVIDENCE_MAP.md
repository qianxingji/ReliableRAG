...
|---|---|---|---|
| 1. Paper artifact | `output/pdf/manuscript.pdf`, `output/pdf/supplement.pdf`, `paper/COMPILE_RECEIPT.json` | The 11-page manuscript and 3-page supplement compile, resolve citations, contain the frozen tables and expose the negative results and limitations. | Journal-specific formatting, authorship, licensing or CAS status. |
...
3. In a repository checkout, run:
   ...
   Expected results are 126 static manuscript checks, a compiled mechanical
   PASS, and a reviewer-map PASS.
