"""Read-only CPU replay boundary with the previously accepted OS bootstrap."""
import hashlib
import os
...
def install(environment, output, allowed_files):
    ...
    forbidden = {'fit', 'fit_transform', 'partial_fit', 'from_pretrained', 'forward', '_ensure_loaded',
                 'encode', 'generate', 'generate_answer', 'generate_repair_query', 'score_likelihoods', 'restore_dataset', 'frozen_inputs'}
