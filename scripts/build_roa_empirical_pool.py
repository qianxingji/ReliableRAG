...
def main():
    ...
    try:
        ...
        source_files = [REPO / name for name in (
            "scripts/build_roa_empirical_pool.py", "scripts/validate_roa_empirical_pool.py",
        ...
        write_json(OUT / "EXECUTABLE_FREEZE.json", dict(status="FROZEN_BEFORE_PROJECTION", commit=commit,
            command=sys.argv, python=sys.version, platform=platform.platform(), inputs=input_records,
